...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/styletimetable.css"/>
        <title>FU AT</title>
    </head>
    <body>
    </div>
    <div class="lecturerinput">
        <form id="lecturerForm" action="timetable" method="POST">
            <input type="text" name="lecturer" value="${requestScope.lecturer}" onchange="this.form.submit()">
            <input type="Submit" name="Submit" value="View">
        </form>
    </div>

    <table class="timetable" style="border:1px">
